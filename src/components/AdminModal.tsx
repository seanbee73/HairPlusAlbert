...
const TEMPLATES = [
  {
    title: 'Announcement: Holiday Schedule & Timely Booking Update',
    category: 'Holiday Hours' as const,
    author: 'Hair Plus Waterloo',
    excerpt: 'Special operating hours and booking availability for upcoming university terms and holidays at 338 Albert St.',
    content: 'Please note our upcoming holiday schedule at Hair Plus (338 Albert St Unit 101, Waterloo):\n\nWe recommend booking in advance via our Timely portal to secure your preferred appointment with Kay or Matthew.\n\nFree parking is available in dedicated spots #26 & #30. Cash payments receive a 10% discount.',
    tags: 'Holiday Hours, Online Booking, Waterloo, UW Students',
  },
  {
    title: 'Matthew’s Guide: Mastering the Korean Mullet & Taper',
    category: 'Barber Craft' as const,
    author: 'Matthew (Senior Stylist)',
    excerpt: 'Why scissor texturizing and Asian hair weight distribution create effortless K-style cuts.',
    content: 'When cutting Asian hair, standard western clippers often cause the hair to flare out on the sides. By isolating the two-block undercut and point-cutting internal weight, the hair lays naturally and frames the jawline effortlessly.\n\nEvery men\'s haircut also includes a thorough scalp cleanse and blowdry styling.',
    tags: 'Korean Mullet, Men\'s Cut, Asian Hair, Scissor Craft',
  },
  {
    title: 'Kay’s Style Spotlight: Face-Framing Curtain Bangs & Layering',
    category: 'Style Showcase' as const,
    author: 'Kay (Lead Designer)',
    excerpt: 'Creating airy curtain bangs and dimensional layering that flatters your facial contours.',
    content: 'Curtain bangs add softness and movement without requiring heavy daily styling. We tailor the angle of the fringe to highlight cheekbone contours, blending into fluid perimeter layers.\n\nBook your 1-on-1 consultation with Kay at Hair Plus Waterloo.',
    tags: 'Curtain Bangs, Korean Layers, Women\'s Cut, Asian Hair',
  },
];
