        ...
        {isBooked ? (
          <div className="text-center py-8 space-y-6">
            ...
            <p className="text-white/70 text-xs max-w-md mx-auto font-normal">
              We look forward to seeing you. If you need to make changes or book via Timely, call us at <a href={BRAND_DATA.phoneTel} className="text-white font-mono underline">{BRAND_DATA.phone}</a>.
            </p>
            <div className="pt-2 flex flex-col sm:flex-row justify-center gap-3">
              ...
              >
                <Phone size={14} /> Call Salon Directly
              </a>
            </div>
          </div>
        ) : (
            ...
            <div className="mb-6">
              <div className="flex items-center gap-2 text-[#9A8C73] mb-1">
                ...
                <span className="text-[10px] tracking-[0.25em] uppercase font-semibold">
                  {BRAND_DATA.name} · {BRAND_DATA.tag}
                </span>
              </div>
              ...
              <p className="text-xs text-white/60 mt-1">
                Online appointment request · Cash (10% discount) &amp; Debit accepted
              </p>
            </div>
